...
let questions = [
    ...
    answer: "They are looking through the files on the system.",
    options: [
    ...
    answer: "Your username and password are required to view the information.",
    options: [
    ...
    answer: "Promptly end the phone call and report the incident to management.",
    options: [
  ...
  },
  {
    ...
    answer: "Act first and think later",
    options: [
      "Not open any links",
  ...
  },
  {
    ...
    answer: "To gain vital personal information",
    options: [
